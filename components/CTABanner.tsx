    ...
    <section className="bg-cream py-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="bg-steel-blue rounded-3xl px-10 py-20 text-center">
          <h2 className="font-serif text-4xl lg:text-5xl font-bold text-white max-w-2xl mx-auto leading-tight mb-10">
            Join 30+ founders and find your next{" "}
            <span className="font-script italic">dream hire</span> with us.
          </h2>
